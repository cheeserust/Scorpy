...
|---|---|---:|---:|---:|---:|
| Board1 | 팔 2~5축 stepper 4개 | `0x01` | `0x101` | `0x201` | `0x301` |
| Board2 | base 1축 stepper 1개 | `0x02` | `0x102` | `0x202` | `0x302` |
...
### 8.2 Board2 base 30.00도, 50ms 이동
