...
| `arm_joint_1` / 팔 2축 | `1` | `0` | `-85` | `90` | `-85` | `-8500` | `9000` | `-8500` |
| `arm_joint_2` / 팔 3축 | `1` | `1` | `-74.5` | `80` | `-78.1` | `-7810` | `8000` | `-7810` |
| `arm_joint_3` / 팔 4축 | `1` | `2` | `-91.5` | `90` | `-91.5` | `-9150` | `9000` | `-9150` |
| `arm_joint_4` / 팔 5축 | `1` | `3` | `-90` | `90` | `-90` | `-9000` | `9000` | `-9000` |
...
## 6. RPi -> STM32 Position Command, CAN ID `0x101` / `0x102`
